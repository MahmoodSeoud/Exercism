...
namespace estate_executor
{
    ...
    {
        int bank_number_part_zhang = zhang::bank_number_part(secret_modifier);
        int bank_number_part_khan = khan::bank_number_part(secret_modifier);
        int bank_number_part_garcia = garcia::bank_number_part(secret_modifier);


        return bank_number_part_garcia + bank_number_part_khan + bank_number_part_zhang;
    }
    ...
    int assemble_code(){
        ...
        return blue_fragments * red_fragments;
    }
