...
static void test_lowercase_letter(void) { TEST_ASSERT_EQUAL(1, score("a")); }
...
static void test_valuable_letter(void) { TEST_ASSERT_EQUAL(4, score("f")); }

static void test_short_word(void) { TEST_ASSERT_EQUAL(2, score("at")); }
...
static void test_medium_word(void) { TEST_ASSERT_EQUAL(6, score("street")); }
...
static void test_empty_input(void) { TEST_ASSERT_EQUAL(0, score("")); }
