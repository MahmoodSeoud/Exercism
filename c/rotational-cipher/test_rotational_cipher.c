...
static void test_rotate_a_by_1(void) { test_rotate("b", "a", 1); }

static void test_rotate_a_by_26_same_output_as_input(void) {
  test_rotate("a", "a", 26);
}

static void test_rotate_m_by_13(void) { test_rotate("z", "m", 13); }

static void test_rotate_n_by_13_with_wrap_around_alphabet(void) {
  test_rotate("a", "n", 13);
}

static void test_rotate_capital_letters(void) { test_rotate("TRL", "OMG", 5); }

static void test_rotate_spaces(void) { test_rotate("T R L", "O M G", 5); }
